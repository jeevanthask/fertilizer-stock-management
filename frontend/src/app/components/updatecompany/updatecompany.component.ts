...
export class UpdatecompanyComponent implements OnInit {
  ...
  updateCompany(firstname: any, secondname: any, email: any, telephone: any, address: any) {
    this.companyService
      .updateCompany(this.companyId, firstname, secondname, email, telephone, address)
      .subscribe(() => {
